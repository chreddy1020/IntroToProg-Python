...
# AReddy, 02/17/2024, Started working on assignment 05
# AReddy, 03/18/2024, Finished assignment 05
# ------------------------------------------------------------------------------------------ #
    ...
    if menu_choice == "1":
        try:
            ...
            if not student_first_name.isalpha():
                raise ValueError("First name must only include alphabetic characters.")
            student_last_name = input("Enter the student's last name: ")
            if not student_last_name.isalpha():
                raise ValueError("Last name must only include alphabetic characters.")
...
print("Program ended. Thank you for registering your students!")
